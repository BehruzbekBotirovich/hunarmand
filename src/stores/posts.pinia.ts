...
export const usePostsStore = defineStore('posts', {
    state: (): PostsState => ({
        posts: [{
            ...
            description: ' Of course the Puget Sound is very watery, and where there is water, there are boats. Today is the Grand Opening of Boating Season when traffic gets stalled in the University District(UW)  Montlake Bridge ',
        ...
        {
            id: 2,
            title: 'How to choose the right laptop for programming ja sjd asjd ajkd asj dajs dajsd jk ejew jk wejr werje ',
            description: ' Choosing the right laptop for programming can be a tough process. It’s easy to get confused while researching the various options. There are many different laptop models out there, each with a different set of trade-offs ',
